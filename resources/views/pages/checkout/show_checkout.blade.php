...
<section id="cart_items">
	<div class="container-fluid">
						...
						<tr>
							...
							<td class="cart_quantity">
								<div class="cart_quantity_button">					
									...
									<input class="cart_quantity" type="mumber" min="1" name="cart_qty[{{$v_cart['session_id']}}]" autocomplete="off" size="2" value="{{$v_cart['product_qty']}}" >									
								</div>
							</td>
							<td class="cart_total">
						...
						<div class="form-one">
							<form method="POST">
								...
								<div class="order-message">
									...
									<textarea name="shipping_notes"  class="shipping_notes"  placeholder="Ghi chú đơn hàng của bạn" rows="2" ></textarea>
								</div>
								...
								<input type="hidden" name="order_coupon" class="order_coupon" value="{{$v_coupon['coupon_code']}}">	
								@endforeach							
								@else
								...
								<input type="button" value="Gửi" name="send_order" class="btn btn-primary btn-sm send_order"></button>										
		...
		<form> <!--Delivery-->
			...
			<button type="button" class="btn btn-info calculate_delivery" name="calculate_fee">Tính phí vận chuyển</button>

			<a class="cart_quantity_delete" href="{{url('/del-fee')}}"><i class="fa fa-times">Chọn lại vận chuyển</i></a>
					...
					<div class="col-sm-6">
						...
						<div class="total_area">
							...
							<ul>
								...
								<li>Thành tiền <span>{{number_format($total-$total_coupon-Session::get('fee'),0,',','.')}}đ</span></li>
								...
								<li>Thành tiền <span>{{number_format($total_coupon-Session::get('fee'),0,',','.')}}đ</span></li>
								@endif
							...
							<ul>
								...
								<li>Thuế <span>0</span></li>
								<li>Phí vận chuyển <span>{{number_format(Session::get('fee'),0,',','.')}}đ</span></li>
								<li>Thành tiền <span>{{number_format($total-Session::get('fee'),0,',','.')}}đ</span></li>
							</ul>
