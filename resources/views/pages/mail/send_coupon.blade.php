...
<body>
	...
	<div class="coupon">
		...
		<div class="container">
			<h3>Mã khuyến mãi dành cho khách thường từ shop <a target="_blank" href="https://lamgiatech.com">https://lamgiatech.com</a>
			</h3>
		</div>
		<div class="container" style="background-color:white">
			...
			<p>Quý khách đã từng mua hàng tại shop <a target="_blank" style="color:red" href="http://lamgiatech.com">hieutantutorial.com</a> nếu đã có tài khoản xin vui lòng <a target="_blank" style="color:red"  href="http://lamgiatech.com/cltech_full/public/login-checkout">đăng nhập</a> vào tài khoản để mua hàng và nhập mã code phía dưới để được giảm giá mua hàng ,xin cảm ơn quý khách.Chúc quý khách thật nhiều sức khỏe và bình an trong cuộc sống. </p>
		</div>
		<div class="container">
