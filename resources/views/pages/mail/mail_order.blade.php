		...
		<div class="col-md-12" >
			...
			<div class="row" style="background: cadetblue;padding: 15px">
				...
				<div class="col-md-6" style="text-align: center;color: #fff;font-weight: bold;font-size: 30px">
					...
					<h6 style="margin:0">DỊCH VỤ BÁN HÀNG - VẬN CHUYỂN - NHẬP KHẨU UY TÍN - CHUYÊN NGHIỆP</h5>
				</div>
				...
				<p style="color:#fff">Mọi chi tiết xin liên hệ website tại : <a target="_blank" href="http://lamgiatech.com/">Shop</a>, hoặc liên hệ qua số hotline : 093 959 8268.Xin cảm ơn quý khách đã đặt hàng shop chúng tôi.</p>
