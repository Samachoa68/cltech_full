...
<head>
	...
	<title>[Lamgiatech.com] Đơn hàng đã giao thành công</title>
		...
		<div class="col-md-12" >
			...
			<div class="row" style="background: #ff66cc;padding: 15px">
				...
				<div class="col-md-6" style="text-align: center;color: #fff;font-weight: bold;font-size: 30px">
					<h4 style="margin:0">LAMGIATECH</h4>
					<h6 style="margin:0">DỊCH VỤ BÁN HÀNG - VẬN CHUYỂN - NHẬP KHẨU CHUYÊN NGHIỆP</h5>

				</div>

				<div class="col-md-6 logo"  style="color: #fff">
					<p>Chào bạn <strong style="color: #000;text-decoration: underline;">{{$shipping_array['customer_name']}}</strong>,chúng tôi đã giao hàng thành công với các thông tin như sau:</p>
				</div>
				...
				<p style="color:#fff;text-align: center;font-size: 15px;">Mọi chi tiết xin liên hệ website tại : <a target="_blank" href="http://lamgiatech.com/">Shop</a>, hoặc liên hệ qua số hotline : 0939598268.Xin cảm ơn quý khách đã mua hàng tại shop chúng tôi.</p>
