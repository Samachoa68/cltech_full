                ...
                <div class="position-center">
                   ...
                   <form role="form" action="{{URL::to('/update-product/'.$pro->product_id)}}" method="post" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                        ...
                        <textarea style="resize: none" rows="8" name="product_desc" class="form-control" id="ckeditor_1">{{$pro->product_desc}}</textarea> 
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Nội dung sản phầm</label>
                        <textarea style="resize: none" rows="8" name="product_content" class="form-control" id="ckeditor_2" >{{$pro->product_content}}</textarea> 
                    </div>

                    <div class="form-group">
                        <label for="exampleInputPassword1">Giá sản phẩm</label>
                        <textarea style="resize: none" rows="1" name="product_price" class="form-control" id="exampleInputPassword1" > {{$pro->product_price}} </textarea> 
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="product_tags" data-role="tagsinput" value="{{$pro->product_tags}}">
                    </div>
